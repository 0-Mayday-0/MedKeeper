...
class Menu:
    ...
    def _edit_stock(self):
        ...
        while user_invalid and not found_meds:
            ...
            user_input = input(s.Menu.External.prompt_edit_stock)
        ...
        while user_invalid and found_meds:
            ...
            user_input = input(s.Menu.External.select_one_edit)
        ...
        while user_invalid and selected:
            user_input: str = input(s.Menu.External.set_to_what)
            ...
            if user_invalid:
                ...
                update_values: dict[str, dict[str, float]] = {
                    s.Atomic.set: {s.Connections.qty_str: float(user_input)}}
                ...
                print(s.Menu.External.EDIT_SUCCESS.format(p=user_input,
                                                         m=selected.get_name,
                                                         i=selected.get_id),
                      f'Ack={update_result.acknowledged}', end='\n\n')
